...
class LightSource {
public:
	virtual void shade( Ray3D&, bool inShadow) = 0;
...
public:
	...
	void shade( Ray3D& ray, bool inShadow);
	//Ray3D shadow (Ray3D& ray);
...
private:
	...
	Colour get_ambient(Material* mat);
	Colour get_diffuse(Material* mat, Vector3D& normal, Vector3D& dirLight);
	Colour get_specular(Material* mat, Vector3D& normal, Vector3D& dirLight, Vector3D& toViewer);
